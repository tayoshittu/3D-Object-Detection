...
"""
# --dataset sunrgbd --checkpoint_path log_sunrgbd/checkpoint.tar --dump_dir eval_sunrgbd --cluster_sampling seed_fps --use_3d_nms --use_cls_nms --per_class_proposal
import os
import sys
import numpy as np
...
from ap_helper import AP_Measurement, parse_predictions, parse_groundtruths
from results_save import save_results
parser = argparse.ArgumentParser()
parser.add_argument('--model', default='detectnet', help='Model file name [default: votenet]')
parser.add_argument('--dataset', default='sunrgbd', help='Dataset name. sunrgbd or scannet. [default: sunrgbd]')
parser.add_argument('--checkpoint_path', default='checkpoint_sunrgbd.tar', help='Model checkpoint path [default: None]')
parser.add_argument('--dump_dir', default='eval_sunrgbd', help='Dump dir to save sample outputs [default: None]')
...
def evaluate_one_epoch():
    stat_dict = {}
    ap_calculator_list = [AP_Measurement(iou_thresh, DATASET_CONFIG.class2type) \
    ...
    for batch_idx, batch_data_label in enumerate(TEST_DATALOADER):
        ...
        if batch_idx% 500 == 0:
            save_results(end_points, DUMP_DIR, DATASET_CONFIG)
